...
public class AdminHorariosControllerTests : IClassFixture<ApiFactory>
{
    ...
    {
        _factory = factory;
        _client = factory.CreateClient(); // já autenticado como Admin via TestAuthHandler
    }
    ...
    private async Task<int> GetMedicoIdAsync()
    {
        ...
        // garante que existe pelo menos um médico (ApiFactory normalmente faz seed)
